...
<img src="./docs/images/demo.jpeg" alt="PyCostAudit Dashboard - Default Real-Time Monitoring Interface" style="width: 100%; display: block; border: 1px solid #ddd; border-radius: 8px; margin: 20px 0;">
